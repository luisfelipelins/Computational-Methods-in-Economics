...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.9\linewidth]{outputs/policy_diff_M2.pdf}
...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.9\linewidth]{outputs/event_study_HL_M2.pdf}
...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.8\linewidth]{outputs/diagram.png}
